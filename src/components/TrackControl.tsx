...
import { gainToDb, gainToSlider, sliderToGain, sliderToDb, formatDb, parseDbInput, hexToRgba } from '../lib/audioUtils';
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="w-12 h-8 min-w-[3rem] min-h-[2rem] max-w-[3rem] max-h-[2rem] rounded-md cursor-pointer flex items-center justify-center shrink-0"
          style={{ 
            border: `2px solid ${track.color || '#60a5fa'}`,
            backgroundColor: track.muted ? (track.color || '#60a5fa') : 'transparent',
            color: track.muted ? '#000' : (track.color || '#60a5fa'),
        ...
        <button
          ...
          style={{ 
            border: `2px solid ${track.color || '#60a5fa'}`,
            backgroundColor: track.solo ? (track.color || '#60a5fa') : 'transparent',
            color: track.solo ? '#000' : (track.color || '#60a5fa'),
            boxSizing: 'border-box',
            padding: 0,
            margin: 0,
            fontSize: '0.875rem',
