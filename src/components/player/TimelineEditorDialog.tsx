...
import { Plus, Edit3, Trash2 } from '../icons/Icon';
import { InteractiveGuitarDiagram, InteractivePianoDiagram, InteractiveUkuleleDiagram } from '../diagrams';
import { ChordMarker, SectionMarker, TempoChange } from '../../types';
